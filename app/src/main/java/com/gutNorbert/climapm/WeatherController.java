package com.gutNorbert.climapm;
...
import com.gutNorbert.climapm.R;
...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "2c6c254d54b591f196ef15ce729e7b82";
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE){
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                Log.d("Clima", "onRequestPermissonResult(): Permission granted!");
                getWeatherForCurrentLocation();
            } else {
    ...
    private void letsDoSomeNetworking(RequestParams params) {
        ...
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler(){
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable e, JSONObject response) {
